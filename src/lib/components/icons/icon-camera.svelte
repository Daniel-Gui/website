...
>
	<g fill="none" class="nc-icon-wrapper">
		<path
			...
			fill="url(#dnay1q9z3z-1752500502771-2780450_camera_existing_0_3xs23rtpc)"
			data-glass="origin"
			mask="url(#dnay1q9z3z-1752500502771-2780450_camera_mask_46e6hi4k9)"
		></path>
		<path
			d="M18 12.5C18 15.8137 15.3137 18.5 12 18.5C8.68629 18.5 6 15.8137 6 12.5C6 9.18629 8.68629 6.5 12 6.5C15.3137 6.5 18 9.18629 18 12.5Z"
			fill="url(#dnay1q9z3z-1752500502771-2780450_camera_existing_0_3xs23rtpc)"
			data-glass="clone"
			filter="url(#dnay1q9z3z-1752500502771-2780450_camera_filter_9s4nsb7fo)"
			clip-path="url(#dnay1q9z3z-1752500502771-2780450_camera_clipPath_3m7r9h6yr)"
		></path>
		<path
			...
			fill="url(#dnay1q9z3z-1752500502771-2780450_camera_existing_1_vfi3lfa08)"
			data-glass="blur"
		></path>
		<path
			...
			fill="url(#dnay1q9z3z-1752500502771-2780450_camera_existing_2_ra7cbeah8)"
		></path>
		<defs>
			<linearGradient
				id="dnay1q9z3z-1752500502771-2780450_camera_existing_0_3xs23rtpc"
				x1="12"
				y1="6.5"
				x2="12"
				y2="18.5"
			...
			<linearGradient
				id="dnay1q9z3z-1752500502771-2780450_camera_existing_1_vfi3lfa08"
				x1="12"
				y1="2"
				x2="12"
				y2="21"
			...
			<linearGradient
				id="dnay1q9z3z-1752500502771-2780450_camera_existing_2_ra7cbeah8"
				x1="12"
				y1="2"
				x2="12"
				y2="13.003"
			...
			<filter
				id="dnay1q9z3z-1752500502771-2780450_camera_filter_9s4nsb7fo"
				x="-100%"
				y="-100%"
				width="400%"
				height="400%"
			...
			<clipPath id="dnay1q9z3z-1752500502771-2780450_camera_clipPath_3m7r9h6yr">
				<path
					d="M14.4648 2C15.1335 2.00001 15.758 2.33423 16.1289 2.89062L17.5352 5H19C21.2091 5 23 6.79086 23 9V17C23 19.2091 21.2091 21 19 21H5C2.79086 21 1 19.2091 1 17V9C1 6.79086 2.79086 5 5 5H6.46484L7.87109 2.89062C8.24202 2.33424 8.86646 2.00001 9.53516 2H14.4648ZM12 8C9.51472 8 7.5 10.0147 7.5 12.5C7.5 14.9853 9.51472 17 12 17C14.4853 17 16.5 14.9853 16.5 12.5C16.5 10.0147 14.4853 8 12 8Z"
					fill="url(#dnay1q9z3z-1752500502771-2780450_camera_existing_1_vfi3lfa08)"
				></path>
			</clipPath>
			<mask id="dnay1q9z3z-1752500502771-2780450_camera_mask_46e6hi4k9">
