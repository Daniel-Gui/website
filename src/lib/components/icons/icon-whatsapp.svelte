...
>
	<defs>
		...
		>
			<stop stop-color="rgba(87, 87, 87, 1)" />
			<stop offset="1" stop-color="rgba(21, 21, 21, 1)" />
		</linearGradient>
		<linearGradient
			...
			gradientUnits="userSpaceOnUse"
		>
			<stop stop-color="rgba(227, 227, 229, 0.6)" />
			<stop offset="1" stop-color="rgba(187, 187, 192, 0.2)" />
		</linearGradient>
		<linearGradient
			id="glass-gloss-gradient"
			x1="20"
			y1="0"
			x2="20"
			y2="20"
	...
	<!-- Base Shape -->
	<rect x="2" y="2" width="36" height="36" rx="8" fill="url(#glass-base-gradient)" />

	<!-- Gloss Overlay -->
	<rect x="2" y="2" width="36" height="36" rx="8" fill="url(#glass-gloss-gradient)" />
